...
check_input :: proc(input: ^Input) {
    ...
    input.events[InputEventId.move_left].is_pressed =
        keyboard_state[SDL.SCANCODE_LEFT] != 0 ||
        keyboard_state[SDL.SCANCODE_A] != 0
    ...
    input.events[InputEventId.move_right].is_pressed =
        keyboard_state[SDL.SCANCODE_RIGHT] != 0 ||
        keyboard_state[SDL.SCANCODE_D] != 0
    ...
    input.events[InputEventId.jump].is_pressed =
        keyboard_state[SDL.SCANCODE_SPACE] != 0
}
